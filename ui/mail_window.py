...
class Ui_MailDialog(object):
    def setupUi(self, MailDialog):
        ...
        self.spinBoxPort.setProperty("value", 65536)
        ...
        self.pushButtonClose = QtWidgets.QPushButton(MailDialog)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
    ...
    def retranslateUi(self, MailDialog):
        ...
        MailDialog.setWindowTitle(_translate("MailDialog", "Pycket - SendMail settings "))
        ...
        self.comboBoxEncrypt.setItemText(0, _translate("MailDialog", "TSL"))
        self.comboBoxEncrypt.setItemText(1, _translate("MailDialog", "SSL"))
        self.comboBoxEncrypt.setItemText(2, _translate("MailDialog", "NONE"))
        ...
        self.pushButtonClose.setText(_translate("MailDialog", "Close"))
