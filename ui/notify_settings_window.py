...
class Ui_NotifySettingsDialog(object):
    def setupUi(self, NotifySettingsDialog):
        ...
        self.gridLayout.addWidget(self.spinBoxSecondsClose, 2, 1, 1, 1)
        ...
        self.gridLayout.addWidget(self.labelSeconds, 2, 2, 1, 1)
        ...
        self.gridLayout.addWidget(self.doubleSpinBoxOpacity, 5, 1, 1, 1)
        self.labelPercent = QtWidgets.QLabel(self.groupBoxGeneral)
        self.labelPercent.setObjectName("labelPercent")
        self.gridLayout.addWidget(self.labelPercent, 5, 2, 1, 1)
